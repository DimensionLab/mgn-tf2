...
def train(data_path=os.path.join(os.path.dirname(__file__), 'datasets', 'flag_simple'), num_steps=10000000, checkpoint=None, wind=False):
...
def main():
    ...
    parser.add_argument("--checkpoint", default=None, help="Path to checkpoint file used to resume training")
    parser.add_argument("--data_path", default=os.path.join(os.path.dirname(__file__), 'datasets', 'flag_simple'), help="Path to dataset")
    parser.add_argument("--num_steps", type=int, default=100000, help="Number of iterations to train (default :1e6)")
